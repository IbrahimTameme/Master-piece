    ...
    <div class="col-lg-5 col-md-6 mt-5 ml-5">
      <div class="card z-index-2 ">
        ...
        <div class="card-body">
          ...
          <a href="{{url('PendingRequests')}}"style="margin-left:15% ; padding-bottom:5%"><button class="btn bg-gradient-primary" >Show Pending Requests</button></a>
          </div>
        </div>
      </div>
    </div>
   <div class="col-lg-5 col-md-6 mt-5 ml-5">
      <div class="card z-index-2 ">
        ...
        <div class="card-body">
          ...
          <hr class="dark horizontal">
          <div class="d-flex ml-5" >
            <a href="{{url('etable')}}"style="margin-left:15%"><button class="btn bg-gradient-primary">Show Accepted Requests</button>
          </div>
        </div>
      </div>
    </div>
